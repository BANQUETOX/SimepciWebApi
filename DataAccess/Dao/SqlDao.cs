...
namespace DataAccess.Dao
{
    public class SqlDao
    {
        private string connectionString = "Connection string completo:\r\nServer=tcp:simepci.database.windows.net,1433;Initial Catalog=SIMEPCI-DB;Persist Security Info=False;User ID=softsolutionadmin;Password= =D7Cs)01E9$\";MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        //Singleton instance
